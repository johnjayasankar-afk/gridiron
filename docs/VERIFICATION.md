...
- Thirteen live fields at 1920x3200 with the replay at 60x, three consecutive solo runs with nothing else on the machine: **zero long tasks in all three**, frames 1.70 to 2.50ms, 151 to 189 draw calls, heap 24 to 40MB. A game page on its own: 0.72 to 0.76ms a frame across 34 draw calls.
