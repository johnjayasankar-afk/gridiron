...
- 620 unit tests, 65 files.
- **142 end-to-end journeys across Chrome and WebKit: 120 run, 22 skipped by their own guards, none failed.** The count was taken from the runner rather than carried forward: the line here read 120 and 104, which had drifted as journeys were added without it being re-counted. Fourteen are the tape and the pulse, fourteen are the field in 3D and the reel, and five are odds and win probability.
